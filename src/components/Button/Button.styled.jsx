...
export const StyledButton = styled.button.attrs(props => ({
    ...
    background: ${p => p.backgroundColor || 'linear-gradient(to right, #000000, #833c0dcd, #000000)'};
    color: ${p => p.color || p.theme.colors.effects};

    &:hover,
    &:focus {
        background: ${p => p.hoverBackground || 'linear-gradient(to right, #833c0dcd, #000000, #833c0dcd)'};
